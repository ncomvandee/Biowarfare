...
{
    [TestFixture]
    public class MonsterReadPageTests : MonsterCellReadPage
    {
        App app;
        MonsterCellReadPage page;
        ...
        public void Setup()
        {
            ...
            page = new MonsterCellReadPage(new GenericViewModel<MonsterModel>(new MonsterModel()));
        }
        ...
        public void MonsterReadPage_Update_Clicked_Default_Should_Pass()
        {
            ...
            // Act
            page.MonsterCellEditButton_Clicked(null, null);
