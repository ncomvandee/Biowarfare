...
namespace UnitTests.Models
{
    ...
    public class BasePlayerModelTests
    {
        ...
        public void BasePlayerModel_Get_Default_Should_Pass()
        {
            ...
            Assert.AreEqual(false, result.Poison);
        ...
        [Test]
        public void BasePlayerModel_Get_Poison_Count_Default_Should_Pass()
        {
            // Arrange
            var data = new BasePlayerModel<CharacterModel>();

            // Act
            int result = data.PoisonCount; 
            // Reset
        ...
        [Test]
        public void BasePlayerModel_Set_Poison_Count_Default_Should_Pass()
        {
            // Arrange
            var data = new BasePlayerModel<CharacterModel>();
            ...
            // Assert
            Assert.AreEqual(4, data.PoisonCount);
        }

        [Test]
        public void BasePlayerModel_Cause_Poison_Check_Poison_Default_Should_Pass()
        {
            // Arrange
            var data = new BasePlayerModel<CharacterModel>();
