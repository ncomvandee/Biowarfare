...
namespace UnitTests.Models
{
    ...
    public class CharacterModelTests
    {
        ...
        public void CharacterModel_Set_Default_Should_Pass()
        {
            ...
            Assert.AreEqual("nkcell_bg.png", result.ImageURI);
        ...
        public void CharacterModel_FormatOutput_Default_Should_Pass()
        {
            ...
            // Assert 
            Assert.AreEqual(true, result.Contains("Osmosis Jones"));
        }
        ...
        public void CharacterModel_Set_Get_Default_Should_Pass()
        {
            ...
            result.Job = CellTypeEnum.Unknown;
        ...
        //{
        //    // ArDefense
        //    var data = new CharacterModel { Job = CellTypeEnum.Fighter };
        ...
        //{
        //    // ArDefense
        //    var data = new CharacterModel { Job = CellTypeEnum.Cleric };
